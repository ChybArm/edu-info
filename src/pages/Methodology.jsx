...
export default function Methodology() {
  ...
  const stepsData = [
    {
      label: 'Դարաշրջան',
      detail: 'Որոշի՛ր, թե պատմական որ ժամանակաշրջանին է վերաբերում գեղարվեստական հատվածը։ Ի՞նչ էր կատարվում աշխարհում, ի՞նչ միջավայրում էր ապրում հեղինակը։',
      example: 'Ռոմանտիզմ՝ 19-րդ դար՝ ազգային ազատագրական շարժումների, ժողովրդական ոգու և լեզվի վերածննդի ժամանակ։',
      question: 'Ի՞նչ էր կատարվում աշխարհում, երբ գործն ստեղծվեց։ Ի՞նչից էին վախենում, ինչ էին ուզում։',
    },
    {
      label: 'Գրական գործ',
      ...
      question: 'Ո՞ր ժանրի է գործը: Ո՞վ, ե՞րբ ու ի՞նչ նպատակով է գրել: Ո՞ւմ համար:',
    },
    {
